...
\section{Stopping}
After the web file content is tokenized, it goes through the stopping phase. This phase removes the unnecessary words that add no value to the data. Removing these words ideally shrinks the file to just about half the size it was after tokenizing. I found a stop list that was published in the Journal of Machine Learning Research created by David Lewis in August 2004 that contains 571 stop words \footnote{http://jmlr.csail.mit.edu/papers/volume5/lewis04a/a11-smart-stop-list/english.stop}.
