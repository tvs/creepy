...
== DESCRIPTION
Creepy is a web crawler written in Python that reads in a list of seeds and branches out from there, scavenging the web until it has collected some specified number of webpages.
